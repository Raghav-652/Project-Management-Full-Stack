...
// <Transition 
// as={Fragment}
// enter='transition ease-out duartion-200'
...
// <span>{getInitials(user?.name)}

// </span>
// </div>

// <div className='flex flex-col gap-y-1'>
//   <p className='text-black text-xl font-bold'>{user.name}


// <span className='text-base text-gray-500'>{user.title}

// </span>

// <span className='text-BLUE-500'>{user.email}
