...
<div className="fixed top-5 right-22 z-50">


<Popover className="relative">
  <Popover.Button className="relative inline-flex items-center outline-none">
    <IoIosNotificationsOutline className="w-8 h-8 text-2xl text-gray-800" />
    {data?.length > 0 && (
      <span 

      className="absolute -top-5 -right-4  m-4 flex items-center justify-center text-xs text-white font-semibold w-4 h-4 rounded-full bg-red-600">
        {data?.length}
      </span>
    )}
  </Popover.Button>
